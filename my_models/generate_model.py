'''
sample_duration=opt.sample_duration修改为sample_duration=opt.in_sample_duration
'''

import torch
from torch import nn
from models import pre_act_resnet, wide_resnet, resnext, densenet
from my_models import resnet_no_fc
...
def generate_model(opt):
    ...
    if opt.model == 'resnet':
        ...
        if opt.model_depth == 10:
            model = resnet_no_fc.resnet10(
                num_classes=opt.n_classes,
                shortcut_type=opt.resnet_shortcut,
                sample_size=opt.sample_size,
                sample_duration=opt.in_sample_duration)
        elif opt.model_depth == 18:
            model = resnet_no_fc.resnet18(
                num_classes=opt.n_classes,
                shortcut_type=opt.resnet_shortcut,
                sample_size=opt.sample_size,
                sample_duration=opt.in_sample_duration)
        elif opt.model_depth == 34:
            model = resnet_no_fc.resnet34(
                num_classes=opt.n_classes,
                shortcut_type=opt.resnet_shortcut,
                sample_size=opt.sample_size,
                sample_duration=opt.in_sample_duration)
        elif opt.model_depth == 50:
            model = resnet_no_fc.resnet50(
                num_classes=opt.n_classes,
                shortcut_type=opt.resnet_shortcut,
                sample_size=opt.sample_size,
                sample_duration=opt.in_sample_duration)
        elif opt.model_depth == 101:
            model = resnet_no_fc.resnet101(
                num_classes=opt.n_classes,
                shortcut_type=opt.resnet_shortcut,
                sample_size=opt.sample_size,
                sample_duration=opt.in_sample_duration)
        elif opt.model_depth == 152:
            model = resnet_no_fc.resnet152(
                num_classes=opt.n_classes,
                shortcut_type=opt.resnet_shortcut,
                sample_size=opt.sample_size,
                sample_duration=opt.in_sample_duration)
        elif opt.model_depth == 200:
            model = resnet_no_fc.resnet200(
                num_classes=opt.n_classes,
                shortcut_type=opt.resnet_shortcut,
                sample_size=opt.sample_size,
                sample_duration=opt.in_sample_duration)
